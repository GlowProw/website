...
import {addPointsToCollection, createCollection, deleteCollection, deletePoint, getCollections, getOrphanPoints, getUserPoints, removePointsFromCollection, updateCollection, updatePoint} from "@/assets/sripts/map_service";
...
let loading = ref(false),
    ...
    collectionPagination = ref({
      page: 1,
      pageSize: 10
    }),
    userCollections: Ref<MapCollection[]> = ref([]),
    savingCollection = ref(false),
    collectionFormModal = ref(false),
    collectionForm: Ref<MapCollection> = ref({
      id: '',
      uuid: '',
      title: '',
      description: '',
...
<template>
  <div class="position-relative">
    ...
    <v-card v-for="(collection,index) in userCollections" :key="index" class="mb-2 pl-4"
            v-if="userCollections && userCollections.length > 0">
      <v-row align="center">
        <v-col cols="auto">
