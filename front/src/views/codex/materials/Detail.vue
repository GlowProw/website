...
<template>
  <v-breadcrumbs>
    <v-container class="pa-0">
      ...
      <v-breadcrumbs-divider></v-breadcrumbs-divider>
      <v-breadcrumbs-item to="/codex/materials">{{ t('codex.materials.title') }}</v-breadcrumbs-item>
      <v-breadcrumbs-divider></v-breadcrumbs-divider>
      <v-breadcrumbs-item>{{ t('codex.material.title') }}</v-breadcrumbs-item>
    </v-container>
  </v-breadcrumbs>
  <v-divider></v-divider>
          ...
          <v-col cols="8">
            ...
            <div class="mt-5 d-flex ga-2">
              ...
              <v-chip class="badge-flavor text-center tag-badge text-black" v-if="materialDetailData.category">
                {{ t(`codex.categorys.${materialDetailData.category}`) }}
              </v-chip>
