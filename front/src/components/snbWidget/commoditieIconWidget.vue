  ...
  <v-tooltip
    ...
    <template v-slot:activator="{ props: activatorProps }">
      <v-card
        ...
        <div class="d-flex align-center">
          <v-img
              class="prohibit-drag"
              :src="commoditiesCardData.icon" cover width="100%" height="100%">
    ...
    <v-card class="demo-reel bg-black" flat border>
      <div class="demo-reel-header pa-10 position-relative"
           :style="`background-color: color-mix(in srgb, hsl(from ${rarityColorConfig[ commodities[i.id]?.rarity || '' ]} h s l) 10%, #000)`">
        ...
        <div class="d-flex ga-2 mt-3">
          <v-chip inline
                  :to="`/codex/commoditie/category/${i.type}`"
